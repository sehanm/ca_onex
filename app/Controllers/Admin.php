...
class Admin extends BaseController
{
    ...
    public function store()
    {
        ...
        $this->auditModel->log('User Created', "Created user $username with ID $userId");
    ...
    public function update($id)
    {
        ...
        if (!empty($changes)) {
            $this->auditModel->log('User Updated', "Updated user ID $id: " . implode(', ', $changes));
        } else {
             $this->auditModel->log('User Updated', "Updated details for user ID $id");
        }
