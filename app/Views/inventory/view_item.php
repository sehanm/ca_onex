            ...
            <div class="glass-card shadow-premium">
                <div class="qr-section">
                    <div class="qr-frame pulse-border">
                        <img src="<?= site_url('inventory/generate-qr/' . $item['id']) ?>?raw=1&t=<?= time() ?>" alt="QR Code"
                            draggable="false">
                    </div>
                ...
                <div class="immutable-details">
                    ...
                    <div class="lock-box mt-4">
                        ...
                        <span>Hardware parameters are cryptographically locked and cannot be edited to maintain
                            traceability.</span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="modern-input-group">
                                    ...
                                    <input type="text" name="asset_code" value="<?= esc($item['asset_code']) ?>"
                                        placeholder="e.g. ICT-MB-2024-001">
                                ...
                                <select name="assigned_user_id">
                                    ...
                                    <?php foreach ($users as $user): ?>
                                        <option value="<?= $user['user_id'] ?>"
                                            <?= $item['assigned_user_id'] == $user['user_id'] ? 'selected' : '' ?>>
                                            <?= esc($user['full_name']) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                    ...
                    <div class="form-section mt-4">
                        ...
                        <div class="modern-input-group">
                            <textarea name="notes" rows="4"
                                placeholder="Describe recent repairs, physical condition, or specific usage constraints..."><?= esc($item['notes']) ?></textarea>
                        </div>
                    </div>
...
<style>
    ...
    .pulse-border {
        ...
        animation: frame-pulse 4s infinite;
    }
